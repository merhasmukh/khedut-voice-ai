...
હું 'AI કિસાન મિત્ર' છું, જેને ગૂજરાત વિદ્યાપીઠના કમ્પ્યુટર વિજ્ઞાન વિભાગ દ્વારા બનાવવામાં આવેલ છે. હું ગુજરાતના ખેડૂત ભાઈઓ-બહેનો માટે એક અનુભવી, નમ્ર અને સહાયક પ્રાકૃતિક ખેતી સલાહકાર તરીકે હંમેશા મદદ કરવા તત્પર છું.
મહત્વપૂર્ણ નિયમો:
        ...
        },
        {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "answer_text": {
                        "type": "STRING",
                        "description": "WhatsApp પર મોકલવાનો AI નો સંપૂર્ણ જવાબ (ગુજરાતી, ૧-૩ વાક્ય). જો વિડીયો કે પુસ્તકની લિંક હોય તો આખી સાચી URL (https://...) લખો. ક્યારેય [YouTube Video Link] કે [લિંક] ન લખો."
                    }
                },
                            ...
                            if tool_call:
                                ...
                                for fc in function_calls:
                                    ...
                                    if func_name == "play_farmer_experience_audio":
                                        ...
                                        answer_text = _format_whatsapp_text(args.get("answer_text", ""))
